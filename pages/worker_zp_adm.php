        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">ТОП-3 сотрудников по зарплатам</p>
                  <div class="table-responsive">
                    <? 
                    $workers = get_worker_by_zp();
                    $i=0;
                    //print_r($workers);
                    ?>
                    <table class="table table-dark">
                      ...
                      <tbody>
                        <?
                        while($i<3){
                          $dep_id = $workers[$i]['department_id'];
                          if($dep_id == 1){
                        ...
                        ?>
                        <tr>
                          <td><?=$workers[$i]['last_name']?> <?=$workers[$i]['name']?></td>
                          <td><?=$workers[$i]['zarplata']?></td>
                          <td><?=$dep ?></td>
                        </tr>
                        <?
                        $i++;
          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Список сотрудников</p>
                  <div class="table-responsive">
                    <table id="recent-purchases-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$value['date_priem'] ?></td>
                            <td><?=$value['zarplata'] ?></td>
                            <td><?=$dep ?></td>
                            <td><b><a style="color: red" href="/pages/actions.php?del_worker=<?=$value['id'] ?>">Удалить</a></b></td>
                        </tr>
                        <?}
                        ?>
                      </tbody>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a href='add_users_adm.php' style="color: white;" type="button" class="btn btn-primary btn-lg btn-block">
                      <i class="mdi mdi-account"></i>Добавить сотрудника</a>
                </div>
              </div>
            </div>
          </div>
